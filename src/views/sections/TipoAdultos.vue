      ...
      features: [
        {
          title: 'Funcionales',
          icon: 'mdi-human-male',
          body: 'Son aquellos que pueden llevar a cabo sus actividades cotidianas sin dificultad o bien con mínima dificultad, por lo que pueden mantenerse independientes.',
        },
        {
          title: 'Disfuncionales',
